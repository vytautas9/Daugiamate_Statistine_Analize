...
plot(lasso_L1, label=TRUE,xvar="lambda", main="L1")
plot(ridge_L2,label=TRUE,xvar="lambda", main="L2")



lasso_L1 <- glmnet(data_pcs %>% select(-label), data_pcs$label, family = "binomial", alpha = 1)
ridge_L2 <- glmnet(data_pcs %>% select(-label), data_pcs$label, family = "binomial", alpha = 0)
plot(lasso_L1, label=TRUE,xvar="lambda", main="L1")
plot(ridge_L2, label=TRUE,xvar="lambda", main="L2")
```
